# Generated by Django 3.1.4 on 2020-12-13 22:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ManyToManyField(related_name='users', through='django_app.Review', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='review',
            name='trail',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='django_app.trail'),
        ),
        migrations.AddField(
            model_name='review',
            name='user',
